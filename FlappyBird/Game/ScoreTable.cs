...
{
    //надо бы сюда закинуть метод изменения текстуры, либо событие
    internal class ScoreTable
    {
        private readonly Renderer _renderer;

        /// <summary>
        /// Key = прямоугольник, содержащий в себе информацию о координатах и индексах текстр <br/>
        ...
        /// </summary>
        /// <returns>Key - сгенерированный прямоугольник <br/> Value - индекс буфера, хранящего указанный прямоугольник</returns>
